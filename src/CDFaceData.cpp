...
void CDFaceData::load( const string& path )
{
	...
	std::cout<<"candide3.wfm read finished ! "<<std::endl;
	CDLog<< "before load";
	istringstream line;
	// load vertices

...
public:
	...
	std::vector<CDFaceDistortionUnit>  getShapeUnits()const { return shapeUnits; }  //gzc

	std::vector<CDFaceDistortionUnit>  getAnimationUnits()const { return animationUnits; }

	CDMesh getCDMesh()const { return meshAtRest; }  //gzc
